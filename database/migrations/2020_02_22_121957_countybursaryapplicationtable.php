...
class Countybursaryapplicationtable extends Migration
{
   /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('countybursaryapplication', function (Blueprint $table) {
    ...
    {
       Schema::dropIfExists('countybursaryapplication'); 
    }
}
