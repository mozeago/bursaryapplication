...
use App\NGcdfBursaryModel;
use Illuminate\Http\Request;

class NgcdfBursaryController extends Controller
{
    ...
    {
        NGcdfBursaryModel::updateOrCreate(['user_id'=>$request->user_id],[
...
/**
    ...
    {
        $storagefeespath="uploads/fees/ngcdf/";
        $storageresultspath="uploads/results/ngcdf/";
        $storageletterpath="uploads/admissionletters/ngcdf/";
        /**fees */
